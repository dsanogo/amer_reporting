            ...
            ?>
                <div class="col-md-5 col-sm-12 col-xs-12 pull-right rtl tabel" >
                    <div class="text-center" style="margin: 5px;">
                        ...
                        <a href="{{route('admin.pdfMonthlyInvoicesProcessTime', ['district_id'=> $district_id, 'daterange' => $date_range])}}" class="btn btn-primary btn-lg" >PDF</a>
                        <a class="btn btn-primary btn-lg sendmail" >Send to mail</a>
                        <a href="{{route('admin.printMonthlyInvoicesProcessTime', ['district_id'=> $district_id, 'daterange' => $date_range])}}" class="btn btn-primary btn-lg printPage">Print</a>

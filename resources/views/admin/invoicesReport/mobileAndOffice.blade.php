            ...
            @if (isset($invoices))
                ...
                <div class="col-md-12 rtl tabel" >
                    <div class="text-center" style="margin: 5px;">
                        ...
                        @endif
                        <a href="{{route('admin.exportMobileAndOfficeInvoices')}}" class="btn btn-primary btn-lg">Excel</a>
                        <a href="{{route('admin.pdfMobileAndOfficeInvoices')}}" class="btn btn-primary btn-lg" >PDF</a>
                        <a class="btn btn-primary btn-lg sendmail" >Send to mail</a>
                        <a href="{{route('admin.printMobileAndOfficeInvoices')}}" class="btn btn-primary btn-lg printPage">Print</a>
